...
test("broad pad repulsion uses the minimum-width geometry without floating-point reassociation", () => {
  ...
  expect(output!.route[1]!.y).toBe(0.16499633789062504)
  expect(output!.route[2]!.y).toBe(0.16499633789062504)
