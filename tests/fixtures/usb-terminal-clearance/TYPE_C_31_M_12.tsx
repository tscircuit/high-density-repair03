...
export const TYPE_C_31_M_12 = (props: ConnectorProps) => {
  return (
    <connector
      ...
      pinLabels={pinLabels}
      pinAttributes={{
        EH1: { requiresGround: true, mustBeConnected: true },
        EH2: { requiresGround: true, mustBeConnected: true },
        EH3: { requiresGround: true, mustBeConnected: true },
        EH4: { requiresGround: true, mustBeConnected: true },
        A1B12: { requiresGround: true, mustBeConnected: true },
        B1A12: { requiresGround: true, mustBeConnected: true },
        A4B9: {
          providesPower: true,
          providesVoltage: "5V",
        ...
        A5: { mustBeConnected: true },
        B5: { mustBeConnected: true },
