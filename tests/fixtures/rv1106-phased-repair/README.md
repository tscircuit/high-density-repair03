...
With both fixes applied to the pinned repair03 code in the downstream
Pipeline9 replay, the relaxed-reference result improves from 36 to 35:
via-clearance reports drop from 9 to 8, while the other report counts stay
at 23 trace, 3 via/trace, and 1 pad/trace. Both connection checks remain empty.
The additional repair03 pass improves from 141 to 129 reports at the same
32-iteration limit. No iteration budget or autorouting phase was changed.
