...
export class AutoroutingDrcEngine {
  ...
  private checkTracePair(
    ...
    return {
      ...
      route_owner_trace_ids: [segmentA.traceId, segmentB.traceId],
      source_trace_id: "",
  ...
  private checkTraceVia(
    ...
    return {
      ...
      route_owner_trace_ids: [segment.traceId, via.traceId],
      route_owner_via_trace_id: via.traceId,
      source_trace_id: "",
  ...
  private checkTraceObstacle(
    ...
    return {
      ...
      pcb_trace_id: segment.traceId,
      route_owner_trace_ids: [segment.traceId],
      source_trace_id: "",
      pcb_trace_error_id: errorId,
      pcb_component_ids: [],
      pcb_port_ids: [
    ...
    for (const viaA of vias) {
      for (const viaB of index.query(getViaBounds(viaA))) {
        ...
        errors.push({
          ...
          route_owner_trace_ids: [viaA.traceId, viaB.traceId],
